...
## Tracks
enum Track { }#Untitled } # Add more tracks here

const MUSIC_TRACKS = {
#	Track.Untitled: preload("res://audio/music/Untitled.mp3"), # Add more tracks here
}

var audio_stream_player: AudioStreamPlayer3D = null
var last_loop_callable: Callable = Callable()

# Called when the node enters the scene tree for the first time.
func _ready():
	self.audio_stream_player = AudioStreamPlayer3D.new()
